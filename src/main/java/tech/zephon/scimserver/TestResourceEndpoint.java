...
public class TestResourceEndpoint {
    ...
    /**
     * This method will simply return a poorly formated SCIM exception and error response code.
     *
     * @return returns a json document that is not in the proper error response format.
     */
    @POST
    @Path("badException")
